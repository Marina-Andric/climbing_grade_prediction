...
<table><tr><td><img src=./readme_files/crag.png width="200px"></td><td><img src=./readme_files/crag-predictions.png width="200px"></td><td><img src=./readme_files/crag-predictions-explanation.png width="200px"></td></tr></table>
...
* How the climber *c* tends to deviate in grading similar routes (annot. -*cmd*- in the paper).
* How the route *r* is differently evaluated by the comminity of climbers (-*md^Y*-). 
* How environmental conditions influence grading of the climber *c* (-*cmd^M*-). 
